from sqlalchemy import Column, Integer, String, DateTime, Text, Boolean, LargeBinary, ForeignKey
...
class Datei(Base):
    ...
    Dateipfad = Column(String(250), nullable=True)
    DateiBLOB = Column(LargeBinary, nullable=True)
